...
type navLinksProps = { goTo: 'matriculese' | 'professores'/*  | 'sobreNos' | 'contato' | 'login'  */ }

export const linksNames: Array<'matriculese' | 'professores' /*|  'sobreNos' | 'contato' | 'login' */> = ['matriculese', 'professores',/* 'sobreNos', 'contato', "login" */]
