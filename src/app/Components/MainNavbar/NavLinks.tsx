...
type navLinksProps = { goTo: 'matriculese' | 'professores' | 'home' /*| 'contato' | 'login'  */ }

export const linksNames: Array<'matriculese' | 'professores' | 'home' /*| 'contato' | 'login' */> = ['home', 'matriculese', 'professores', /* 'contato', "login" */]
...
const links = {
    ...
    professores: { href: './professores', name: 'Professores' },
...
export async function NavIndividualLinks({ goTo }: Readonly<navLinksProps>)
{
    ...
    hover:text-redMain sm:hover:text-redMain after:absolute after:left-0 after:right-0 after:bottom-0 after:h-0.5
